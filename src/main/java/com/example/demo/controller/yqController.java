...
public class yqController {
    ...
    //配置您申请的KEY
    public static final String APICODE = "3734c998fd7447468a75753a409f7e76";
    //1.API方法
    @RequestMapping(value= "/getjson")
    public void getRequest(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        request.setCharacterEncoding("UTF-8");
        response.setCharacterEncoding("UTF-8");
        response.setHeader("contentType", "text/html; charset=utf-8");
        String name = request.getParameter("name");
        String result = null;
        String url = "https://api.yonyoucloud.com/apis/dst/ncov/"+name; //请求接口地址
        String method = "GET";
    ...
    public static String net(String strUrl, Map < String, Object > params, Map < String, Object > headerParams, String method, String paramFormat) throws Exception {
        ...
        try {
            ...
            if(headerParams.containsKey("Content-Type")) contentType = headerParams.get("Content-Type").toString();
            ...
            if(params != null && method.equals("POST")) {
                try {
                    ...
                    if("form".equals(paramFormat)) {
                        if("application/x-www-form-urlencoded".equals(contentType)) out.write(urlencode(params).getBytes("utf-8"));
                        else if("application/xml".equals(contentType)) out.write(xmlencode(params).getBytes("utf-8"));
                        else out.write(jsonencode(params).getBytes("utf-8"));
                    } else out.write(params.toString().getBytes("utf-8"));
                } catch(Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public static String jsonencode(Map < String, Object > data) {
        ...
        for(Map.Entry i: data.entrySet()) jparam.put(i.getKey().toString(), i.getValue());
    ...
    public static String xmlencode(Map < String, Object > data) {
        ...
        for(Map.Entry i: data.entrySet()) xmlData.append("<" + i.getKey() + ">" + i.getValue() + "</" + i.getKey() + ">");
